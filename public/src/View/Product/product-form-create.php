	...
	<div class="row container">
		<div class="col-6 form-product">
			<form action="../Route/product-create.php" method="post">
				<input class="data" type="text" name="name" title="Mínimo 2, máximo 50 caracteres. Ex: Notebook" pattern="^([A-Z][\w\s\dáâéêíóôú].{0,50})" placeholder ="Novo Produto" onfocus="this.value='';" required>
