				...
				<input class="data" type="text" name="description" title="Mínimo 2, máximo 500 caracteres. Ex: 8GB RAM, 32GB INTERNO, OCTACORE..." pattern="^([\w\s\dáâãéêíóõôúç].{0,500})" placeholder="Descrição" onfocus="this.value='';" required>
