				...
				<input id="newDesc" class="data" type="text" name="description" title="Mínimo 2, máximo 250 caracteres. Ex: 8GB RAM, 32GB INTERNO, OCTACORE..." pattern="^([\w\s\dáâãéêíóõôúç].{0,255})" placeholder="Descrição" onfocus="this.value='';" required>
