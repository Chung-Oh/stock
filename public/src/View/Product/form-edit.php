	...
	<div class="row container">
		<div class="col-6 form-product">
			<form action="../Route/product-update.php" method="post">
				...
				<input id="newWeight" class="data" type="text" name="weight" title="Mínimo 2, máximo 100 caracteres. Ex: 160 GRAMA" pattern="^([\w\s\dáâãéêíóõôúç].{0,100})" placeholder="Peso" onfocus="this.value='';" required>
