	...
	<div class="row container">
		<div class="col-6 form-product">
			<form action="../Route/product-edit.php" method="post">
				...
				<input id="newDesc" class="data" type="text" name="description" title="Mínimo 2, máximo 250 caracteres. Ex: 8GB RAM, 32GB INTERNO, OCTACORE" pattern="^([\w\s\dáâéêíóôú].{0,250})" placeholder="Descrição" onfocus="this.value='';" required>
