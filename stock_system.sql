...
--
-- Host: localhost    Database: stock_system
-- ------------------------------------------------------
...
--
-- Current Database: `stock_system`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `stock_system` /*!40100 DEFAULT CHARACTER SET utf8 */;
